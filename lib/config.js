...
export const OUTPUT_DIR = path.join(BASE_DIR, "output"); // For saving processed images
...
// In lib/config.js - update DEFAULT_HOTSPOT definition
/** @type {{x: number, y: number, width: number, height: number}} */
export const DEFAULT_HOTSPOT = {
  x: 0.5,
  y: 0.5,
  width: 1, // Full width by default
  height: 1, // Full height by default
};
